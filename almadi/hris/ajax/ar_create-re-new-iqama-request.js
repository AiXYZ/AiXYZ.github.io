	...
	$('#iqamaListOfPdf tbody').on( 'click', 'tr', function () {
    	...
    	.done(function( msg ){
    		...
    		$('#reNewIqamaTable > tbody').append(
    			'<tr>'+
    				'<td><strong>رقـم المـلف</strong><br>'+employeeIdNo+'</td>'+
    				'<td><strong>الاســم</strong><br>'+iqama_employee_name['iqama_employee_name']+'</td>'+
    				'<td><strong>المشـروع</strong><br>'+iqama_employee_pname['iqama_employee_pname']+'</td>'+
    				'<td><strong>المهنـة</strong><br>'+iqama_employee_position['iqama_employee_position']+'</td>'+
    			'</tr>'+
    			'<tr>'+
    				'<td><strong>رقم الاقــامة </strong><br>'+employee_iqama_number['employee_iqama_number']+'</td>'+
    				'<td><strong>تاريخ انتهاء الاقــامة ميلادي </strong><br>'+employee_iqama_g_date['employee_iqama_g_date']+'</td>'+
    				'<td><strong>تاريخ انتهاء الاقــامة هجري </strong><br>'+employee_iqama_h_date['employee_iqama_h_date']+'</td>'+
    				'<td><strong>عدد الايـام </strong><br>'+remainingDays['remainingDays']+'</td>'+
