...
// HR for declined
if($_GET['path'] == 'EnR_declined'){
	$rename = 'EnR_hr_declined_'.$unique_code.'_';
	$photo_path = '../../../upload/request_file/extend_request/';
	$data_path = '../upload/request_file/extend_request/'.$rename;
...
if(@$request_hr == 'TRUE'){
	// Update file
	$uploadFile = "UPDATE extend_info SET ".$column_name." = '".$data_path.$_FILES['SelectedFile']['name']."' WHERE tcode_vacation = '".$_GET['tcode']."'";
