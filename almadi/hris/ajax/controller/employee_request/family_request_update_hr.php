...
@$fr_tcode = $_POST['fv_code'];
@$fr_hr_received_notes = $_POST['fv_hr_notes'];

//@$fr_tcode = "20160620094145";
...
$created = "SELECT tcode_vacation, date_created FROM family_info WHERE tcode_vacation = '".$fr_tcode."' ";
 ...
 * 3 - closed
 */
$updateHRReceived = "UPDATE family_info SET 
