...
// HR First
if($_GET['path'] == 'salary_increase_hr_first'){
	...
	$column_name = 'hr_first_file_path';
	$request = 'TRUE';
}
// HR First
...
// Approval
if($_GET['path'] == 'salary_increase_approval'){
	$rename = 'approval_'.$unique_code.'_';
	$photo_path = '../../../upload/request_file/salary_increase_request/';
	$data_path = '../upload/request_file/salary_increase_request/'.$rename;
	$column_name = 'hr_second_file_path';
	$request = 'TRUE';
}
// Approval
...
// HR Final
if($_GET['path'] == 'salary_increase_hrfinal'){
	$rename = 'hrfinal_'.$unique_code.'_';
	$photo_path = '../../../upload/request_file/salary_increase_request/';
	$data_path = '../upload/request_file/salary_increase_request/'.$rename;
	$column_name = 'hr_third_file_path';
	$request = 'TRUE';
}
// HR Final
...
if(@$request == 'TRUE'){
	// Update Images
	$uploadFile = "UPDATE salary_increase_request_info SET ".$column_name." = '".$data_path.$_FILES['SelectedFile']['name']."' WHERE tcode_vacation = '".$_GET['tcode']."'";
