...
//			},
	...
	$('#listOfExtendReEntryRequestHr tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(EnR_hr_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToExtendReEntryHrTable, a[href="#extendReEntryHr"]').click(function() {
	...
	$('#listOfExtendReEntryRequestClosed tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(EnR_closed_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToExtendReEntryClosedTable, a[href="#extendReEntryClosed"]').click(function() {
	...
	$('#listOfExtendReEntryRequestDeclined tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(EnR_declined_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToExtendReEntryDeclinedTable, a[href="#extendReEntryDeclined"]').click(function() {
