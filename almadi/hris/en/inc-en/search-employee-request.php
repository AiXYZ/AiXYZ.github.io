<div id="employeeRequestModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="width: 900px; margin-left: -450px; margin-top: -360px">
  ...
  <div class="modal-body" style="max-height: none;">
	<div class="row-fluid">
		<div class="accordion" id="accordionSearchRequest">
		  <!-- Personal information start -->
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#personalInformationSearchRequest">
				Personal information
			  </a>
			</div>
			<div id="personalInformationSearchRequest" class="accordion-body collapse in">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#contractInformationSearchRequest">
				Contract information
			  </a>
			</div>
			<div id="contractInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#passportInformationSearchRequest">
				Passport information
			  </a>
			</div>
			<div id="passportInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#iqamaInformationSearchRequest">
				Iqama information
			  </a>
			</div>
			<div id="iqamaInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#molAndGgodiInformationSearchRequest">
				MOL and GOSI information
			  </a>
			</div>
			<div id="molAndGgodiInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#bankInformationSearchRequest">
				Bank information
			  </a>
			</div>
			<div id="bankInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#medicalInformationSearchRequest">
				Medical information
			  </a>
			</div>
			<div id="medicalInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
		        <div class="row-fluid">
					<div class="span3">	
		  ...
		  <div class="accordion-group">
			<div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionSearchRequest" href="#requestInformationSearchRequest">
				Request information
			  </a>
			</div>
			<div id="requestInformationSearchRequest" class="accordion-body collapse">
			  <div class="accordion-inner">
				<!-- table start-->
