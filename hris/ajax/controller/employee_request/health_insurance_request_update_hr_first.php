...
$created = "SELECT tcode_vacation, date_created FROM health_insurance_info WHERE tcode_vacation = '".$tcode."' ";
...
$updateHR_First = "UPDATE health_insurance_info SET first_notes = '".$hr_first_notes."', first_update_by = '".$hrUpdateBy."', first_created	 = '".$hrUpdateCreated."', first_update_days = '".$elapsedDays."', request_status = 2 WHERE tcode_vacation = '".$tcode."' ";
