...
@$tcode = $_POST['tcode'];
@$transfer_request_fd_notes = $_POST['transfer_request_fd_notes'];
...
$created = "SELECT tcode_vacation, hr_update_created FROM request_personnel_transfer_info WHERE tcode_vacation = '".$tcode."' ";
...
$updateFD = "UPDATE request_personnel_transfer_info SET
					fd_update_by = '".$fdUpdateBy."',
					fd_update_created = '".$fdUpdateCreated."',		
					fd_update_days = '".$elapsedDays."',		
					notes_fd = '".$transfer_request_fd_notes."',
					request_status = 3
