...
// HR for declined
if($_GET['path'] == 'fv_declined'){
	$rename = 'fv_hr_declined_'.$unique_code.'_';
	$photo_path = '../../../upload/request_file/family_request/';
	$data_path = '../upload/request_file/family_request/'.$rename;
...
if(@$request_hr == 'TRUE'){
	// Update file
	$uploadFile = "UPDATE family_info SET ".$column_name." = '".$data_path.$_FILES['SelectedFile']['name']."' WHERE tcode_vacation = '".$_GET['tcode']."'";
