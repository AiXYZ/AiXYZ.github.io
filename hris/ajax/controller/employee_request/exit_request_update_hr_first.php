...
$created = "SELECT tcode_vacation, date_created FROM exit_request_info WHERE tcode_vacation = '".$tcode."' ";
 ...
 * 9 - Declined
 */
$updateHRFirst = "UPDATE exit_request_info SET last_vacation_date = '".$last_vacation_date."', date_joined_last_vacation = '".$date_joined_after_vacation."', days_of_last_vacation = '".$days_of_last_vacation."', notes_hr = '".$hr_first_notes."', hr_update_by = '".$hrUpdateBy."', hr_update_created = '".$hrUpdateCreated."', hr_update_days = '".$elapsedDays."', request_status = 2 WHERE tcode_vacation = '".$tcode."' ";
