...
//			},
	...
	$('#listOfFeRequestHrReceived tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(fr_hr_received_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToFeHrReceivedTable, a[href="#feHrReceived"]').click(function() {
	...
	$('#listOfFeHrRequestClosing tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(fr_hr_closing_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToFeHrClosingTable, a[href="#feHrClosing"]').click(function() {
	...
	$('#listOfFeRequestClosed tbody').on( 'click', 'tr', function () {
		...
		// 0 - Not Clickable
		// 1 - Clickable
		if(fr_hr_closed_rowData[9] == 0){ // to make not clickable row
			return false;
		}
    ...
    $( '#goBackToFeClosedTable, a[href="#feClosed"]').click(function() {
