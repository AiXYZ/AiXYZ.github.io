!function($, wysi) {
		...
		var tpl = {
				...
				"lists": function(locale, options) {
						...
						return "<li>" +
								...
								"<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='icon-list-ol'></i></a>" +
								"<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='icon-align-right'></i></a>" +
								"<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='icon-align-left'></i></a>" +
								"</div>" +
								"</li>";
				},
				...
				"link": function(locale, options) {
						...
						return "<li>" +
								...
								"<button href='#' class='btn btn-info' data-dismiss='modal'>" + locale.link.insert + "</button>" +
								"</div>" +
								"</div>" +
								"</div>" +
								"</div>" +
								"<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='icon-external-link'></i></a>" +
								"</li>";
				},
				...
				"image": function(locale, options) {
						...
						return "<li>" +
								...
								"<button class='btn btn-info' data-dismiss='modal'>" + locale.image.insert + "</button>" +
								"</div>" +
								"</div>" +
								"</div>" +
								"</div>" +
		...
		Wysihtml5.prototype = {
				...
				initInsertImage: function(toolbar) {
						...
						var insertButton = insertImageModal.find('.btn-info');
				...
				initInsertLink: function(toolbar) {
						...
						var insertButton = insertLinkModal.find('.btn-info');
						var initialValue = urlInput.val();
						var caretBookmark;
